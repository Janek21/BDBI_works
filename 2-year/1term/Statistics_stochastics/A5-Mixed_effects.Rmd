...
```{r}
cat("The model that fits the data better is")
...
cat("The value reference distribution is", ref_dist)
...
cat("To determine if the fixed effects are significant, we look at the p-values. Our p-values for the intercept and days are < 0.05, so they are considered statistically significant. However, our p-value for EducationLevel is > 0.05, indicating that it is not statistically significant.\n")
